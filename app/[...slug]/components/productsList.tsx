        ...
        <React.Fragment>
            <div className="p-[80px_120px] max-2xl:p-[80px_100px] max-lg:p-[60px_80px] max-md:p-[40px_20px]">
                ...
                <div className="flex flex-col items-center">
                    <Heading
                        title={<> High-Quality Roofing & Structural Products in <span className="text-[#fa4729]">{props.location.charAt(0).toUpperCase() + props.location.slice(1)}</span></>}
                        className="text-center"
                    />
                    <Paragraph
                        title={`Typhon supplies a complete range of advanced roofing and steel structural products for industrial, commercial, and institutional projects in ${props.location.charAt(0).toUpperCase() + props.location.slice(1)} and surrounding regions. Engineered with precision and built using premium-grade materials, our products are designed to deliver long-term durability, load efficiency, resistance to weather conditions, and superior structural performance. Whether you're working on a factory expansion, commercial building, warehouse development, or architectural structure, our products help you achieve faster construction timelines with uncompromised quality.`}
