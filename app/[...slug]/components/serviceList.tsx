        ...
        <React.Fragment>
            <div className="p-[80px_120px] max-2xl:p-[80px_100px] max-lg:p-[60px_80px] max-md:p-[40px_20px]">
                ...
                <div className="flex flex-col items-center">
                    <Heading
                        title={<> Roofing & Steel Structure Services in <span className="text-[#fa4729]">{props.location.charAt(0).toUpperCase() + props.location.slice(1)}</span></>}
                        className="text-center"
                    />
                    <Paragraph
                        title={`Typhon provides complete roofing and steel structure solutions for industries, factories, commercial buildings, institutions, real estate developers, and infrastructure projects across ${props.location.charAt(0).toUpperCase() + props.location.slice(1)}. Our services are designed to deliver speed, safety, and engineering precision—ensuring your project runs smoothly from design to installation. With a dedicated team of welders, fabricators, engineers, and erection specialists, we execute every service with unmatched craftsmanship and quality.`}
