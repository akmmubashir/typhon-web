    ...
    <div className="flex flex-col">
      <div className="w-full relative">
        <Image
          ...
          height={800}
        />
        <div className="bg-[#13163D] flex flex-col gap-10 max-lg:gap-5 lg:absolute bottom-[-60px] left-0 w-2/5 max-lg:w-full p-[120px] max-2xl:p-[100px] max-lg:p-[60px_80px] max-md:p-[50px_20px]">
          <div>
            <SubHeading
